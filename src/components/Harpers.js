...
<div>
  <Container className="Container custom-container">
      ...
      <Col className="text-center" xs={12} sm={10} md={8} lg={8} xl={10} xxl={10}>
        ...
        <Row className="align-items-center">
          <Col className="text-start d-flex align-items-center"> 
            <Button href="/HarpersHM" className="border-0" size="sm" variant="outline-primary"><p className="HMText align-items-center">Hunters Mark<br />(inactive)</p></Button>
              </Col>
              <Col className="text-center" xs={7} sm={7} md={7} lg={7} xl={7} xxl={7}>
                <Button className="AttackButton" size="sm" variant="outline-dark" onClick={generateHits}>Longbow attack</Button>
              </Col>
              <Col className="text-start d-flex align-items-center">
                <Button className="border-0" size="sm" variant="outline-primary" href="/HarpersRanged"><p className="fw-normal small mb-0 SwitchText">Swap to shortsword</p></Button>
              </Col>
        </Row>
        <Row>
